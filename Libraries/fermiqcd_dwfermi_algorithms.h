...
void (*default_dwfermi_action)(dwfermi_field &, dwfermi_field &, gauge_field &,
		coefficients &) = DWFermiActionFast::mul_Q;

/// Executes the current dwfermi action
void mul_Q(dwfermi_field &psi_out, dwfermi_field &psi_in, gauge_field &U,
		coefficients &coeff) {
...
inversion_stats (*default_dwfermi_inverter)(dwfermi_field &, dwfermi_field &,
...
inversion_stats mul_invQ(dwfermi_field &psi_out, dwfermi_field &psi_in,
		gauge_field &U, coefficients &coeff, mdp_real absolute_precision =
				dwfermi_inversion_precision, mdp_real relative_precision = 0,
		int max_steps = 2000) {
	return (*default_dwfermi_inverter)(psi_out, psi_in, U, coeff,
