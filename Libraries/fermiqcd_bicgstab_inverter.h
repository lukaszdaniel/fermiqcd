...
//////////////////////////////////////////////////////////////////
#ifndef fermiqcd_bicstab_inverter_
#define fermiqcd_bicstab_inverter_
...
inversion_stats BiConjugateGradientStabilizedInverter(fieldT &psi_out,
		fieldT &psi_in, fieldG &U, coefficients &coeff,
		mdp_real absolute_precision = mdp_precision,
		mdp_real relative_precision = 0, int max_steps = 2000) {
	return BiCGStab::inverter(psi_out, psi_in, U, coeff, absolute_precision,
			relative_precision, max_steps);
}

#endif /* fermiqcd_bicstab_inverter_ */
