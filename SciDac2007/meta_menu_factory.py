...
class MenuFactory:
    ...
    def build(self, menu, label, command):
        ...
        elif type(command) == type(BooleanVar()) and type(
                command.get()) == type(True):
            menu.add_checkbutton(label=label, variable=command)
        elif type(command) == type(StringVar()) and type(
                command.get()) == type(""):
        ...
        [
            ...
            [
                ...
                [
                    ...
                    [
                        ["Subsubsection1", tc],
                        ["Subsubsection2", [["A", tc], ["B", tc]]],
                    ],
                ],
            ],
        ],
        ["Radios", [["A", sv], ["B", sv], ["C", sv]]],
        [
            "Dialogs",
            [
                ["Dialog", lambda: EntryDialog(root, "Title", "What?", sv)],
