...
class Vector:
    ...
    def __getitem__(self, key):
        ...
        if key < 0:
            key = key + len(self)
        try:
            return self.tk.getdouble(self.tk.globalgetvar(
                self._name, str(key)))
        except tkinter.TclError:
    ...
    def search(self, start, end=None):
        return self._master._getints(
            self.tk.call(self._name, "search", start, end))
...
def _doConfigure(widget, subcommand, option, kw):
    ...
    if option:
        ...
        option = "-" + option
        optionInfo = widget.tk.splitlist(
            widget.tk.call(subcommand + (option, )))
...
class Graph(tkinter.Widget):
    ...
    def axis_invtransform(self, axisName, value):
        return self.tk.getdouble(
            self.tk.call(self._w, "axis", "invtransform", axisName, value))

    def axis_limits(self, axisName):
        return self._getdoubles(
            self.tk.call(self._w, "axis", "limits", axisName))
    ...
    def axis_transform(self, axisName, value):
        return self.tk.getint(
            self.tk.call(self._w, "axis", "transform", axisName, value))
    ...
    def xaxis_invtransform(self, value):
        return self.tk.getdouble(
            self.tk.call(self._w, "xaxis", "invtransform", value))
    ...
    def xaxis_transform(self, value):
        return self.tk.getint(
            self.tk.call(self._w, "xaxis", "transform", value))
    ...
    def x2axis_invtransform(self, value):
        return self.tk.getdouble(
            self.tk.call(self._w, "x2axis", "invtransform", value))
    ...
    def x2axis_transform(self, value):
        return self.tk.getint(
            self.tk.call(self._w, "x2axis", "transform", value))
    ...
    def yaxis_invtransform(self, value):
        return self.tk.getdouble(
            self.tk.call(self._w, "yaxis", "invtransform", value))
    ...
    def yaxis_transform(self, value):
        return self.tk.getint(
            self.tk.call(self._w, "yaxis", "transform", value))
    ...
    def y2axis_invtransform(self, value):
        return self.tk.getdouble(
            self.tk.call(self._w, "y2axis", "invtransform", value))
    ...
    def y2axis_transform(self, value):
        return self.tk.getint(
            self.tk.call(self._w, "y2axis", "transform", value))
    ...
    def element_bind(self, tagName, sequence=None, func=None, add=None):
        return self._bind((self._w, "element", "bind", tagName), sequence,
                          func, add)
    ...
    def element_closest(self, x, y, *args, **kw):
        ...
        success = self.tk.getint(
            self.tk.call((self._w, "element", "closest", x, y, var) +
    ...
    def legend_bind(self, tagName, sequence=None, func=None, add=None):
        return self._bind((self._w, "legend", "bind", tagName), sequence, func,
                          add)
    ...
    def pen_names(self, *args):
        return self.tk.splitlist(self.tk.call((self._w, "pen", "names") +
                                              args))
    ...
    def marker_bind(self, tagName, sequence=None, func=None, add=None):
        return self._bind((self._w, "marker", "bind", tagName), sequence, func,
                          add)
    ...
    def marker_create(self, type, **kw):
        return self.tk.call((self._w, "marker", "create", type) +
                            self._options(kw))
...
class Tabset(tkinter.Widget):
    ...
    def insert(self, position, name1, *names, **kw):
        self.tk.call((self._w, "insert", position, name1) + names +
                     self._options(kw))
    ...
    def tab_names(self, *args):
        return self.tk.splitlist(self.tk.call((self._w, "tab", "names") +
                                              args))
